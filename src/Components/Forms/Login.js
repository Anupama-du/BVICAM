            ...
            >
              ...
              <>
                ...
                <input
                  ...
                  />
                <button
                  className="mb-1 flex h-10 w-full items-center justify-center gap-1 rounded-md border-[1.5px] border-solid border-blue-900 bg-slate-800 p-1 font-bold tracking-wide text-slate-200 hover:bg-blue-900 focus:bg-blue-900 disabled:cursor-wait dark:border-blue-300 dark:bg-blue-600 dark:text-slate-50 dark:hover:bg-slate-900 dark:focus:bg-slate-900 lg:mb-2 "
                  type="submit"
                  value="Login"
                ...
                : <p className="w-full bg-blue-300 dark:bg-blue-950/90 duration-200 rounded p-4 my-12 text-center">Select User Type</p>  }
